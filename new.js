...
// task 6
// В кожному масиві є унікальний рядок, в якому не повторюються літери. Найдіть і виведіть в консоль цей рядок.

// має бути такий результат
// findUniq(["abc", "acb", "bac", "fofo", "bca", "cab", "cba"]); // === 'foo'
// findUniq(["fghj", "ghfj", "abcd", "jhgf", "fghj", "fgjh", "ghjf"]); // === 'abcd'
// findUniq(["qwe", "camp", "acmp", "pmac", "camp", "apmc", "pmac"]); // === 'qwe'

function findUniq(params) {
  const param = params.map((string) => {
...
console.log(findUniq(["fghj", "ghfj", "cbad", "jhgf", "fghj", "fgjh", "ghjf"]));
